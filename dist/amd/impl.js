define(['exports', 'aurelia-metadata', 'aurelia-loader', 'aurelia-pal', './meteor-require'], function (exports, _aureliaMetadata, _aureliaLoader, _aureliaPal, _meteorRequire) {
  'use strict';
      ...
      return new Promise(function (resolve, reject) {
        try {
          if (loaderPlugin) {
            ...
            resolve((0, _meteorRequire.meteorRequire)(path));
          }
        } catch (e) {
          reject(e);
        }
