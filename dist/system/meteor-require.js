...
System.register(['./string-lib'], function (_export, _context) {
  "use strict";

  var toUpperCamelCase;
  return {
    setters: [function (_stringLib) {
      toUpperCamelCase = _stringLib.toUpperCamelCase;
    }],
    execute: function () {
      ...
      _export('meteorRequire', meteorRequire);
    }
  };
});